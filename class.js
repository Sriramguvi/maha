...
document.getElementsByName("th1").innerText="Rank";
let th2=document.createElement("thead");
document.getElementsByName("th2").innerText="first";
let th3=document.createElement("thead");
document.getElementsByName("th3").innerText="last";
